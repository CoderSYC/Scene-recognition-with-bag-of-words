...
switch lower(FEATURE)    
    ...
    case 'bag of sift'
        ...
        if ~exist('vocab.mat', 'file')
            ...
            fprintf('Visual word vocabulary found!\n')
        end
        
        % YOU CODE get_bags_of_sifts.m
        %if ~exist('train_bags_of_sift.mat', 'file')
        %    fprintf('Training images SIFT features!\n')
            train_image_feats = get_bags_of_sifts(train_image_paths);
        %    save('train_bags_of_sift.mat', 'train_image_feats')
        %else
        %    fprintf('train_bags_of_sift.mat exist! Loading...\n')
        %    load('train_bags_of_sift.mat')
        %end
        %if ~exist('test_bags_of_sift.mat', 'file')
        %    fprintf('Testing images SIFT features!\n')
            test_image_feats  = get_bags_of_sifts(test_image_paths);
        %    save('test_bags_of_sift.mat', 'test_image_feats')
        %else
        %    fprintf('test_bags_of_sift.mat exist! Loading...\n')
        %    load('test_bags_of_sift.mat')
        %end
    ...
    case 'gist'
        if ~exist('train_gist_feat.mat', 'file')
            fprintf('Training images gist features!\n')
            train_image_feats = get_image_gists(train_image_paths);
        else
            fprintf('train_gist_feat exist! Loading...\n')
            load('train_gist_feat.mat')
        end
        if ~exist('test_gist_feat.mat', 'file')
            fprintf('Testing images gist features!\n')
            test_image_feats  = get_image_gists(test_image_paths);
         else
            fprintf('test_gist_feat exist! Loading...\n')
            load('test_gist_feat.mat')
        end     
    otherwise
